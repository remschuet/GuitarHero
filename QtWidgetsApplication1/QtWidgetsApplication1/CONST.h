...
const QStringList CHANSON_FACILE = { "Billie Eilish - Bad Guy", "Coldplay - Hymn for the Weekend","Katy Perry - Hot N Cold", "Noisestorm - Crab Rave", "One Republic - Counting Stars" , "P!nk - So What", "The Offspring - Half Truism"};
const QStringList CHANSON_INTERMEDIAIRE = { "Billie Eilish - Bad Guy", "Coldplay - Hymn for the Weekend","Katy Perry - Hot N Cold", "Les Cowboys Fringants - Les etoiles filantes", "Noisestorm - Crab Rave", "One Republic - Counting Stars" , "P!nk - So What", "The Offspring - Half Truism", "The Offspring - You're Gonna Go Far, Kid"};
const QStringList CHANSON_DIFFICILE = { "Billie Eilish - Bad Guy", "Coldplay - Hymn for the Weekend", "Katy Perry - Hot N Cold", "Noisestorm - Crab Rave", "One Republic - Counting Stars" , "P!nk - So What", "The Offspring - Half Truism", "The Offspring - You're Gonna Go Far, Kid" };
